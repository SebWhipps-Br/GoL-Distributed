...
# 512x512x1000-1-8
benchmark_data['threads'] = benchmark_data['name'].str.extract('Threads/512x512x1000-(\d+)-\d+').apply(pd.to_numeric)
benchmark_data['cpu_cores'] = benchmark_data['name'].str.extract('Threads/512x512x1000-\d+-(\d+)').apply(pd.to_numeric)
